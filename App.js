  ...
  return (
    <View style={ estilos.container }>
        ...
        <View style={ estilos.boxIcones}>
          ...
          <View style={ estilos.iconesLista}>
            <MaterialCommunityIcons name="account-box" size={24} color="#1e71d7" />
            <MaterialCommunityIcons name="alarm" size={24} color="#f16658" />
            <MaterialCommunityIcons name="alert-circle" size={24} color="gold" />
            <MaterialCommunityIcons name="autorenew" size={24} color="green" />
            <MaterialCommunityIcons name="camera-outline" size={24} color="#323232" />
            <MaterialCommunityIcons name="cart" size={24} color="#6a6a6a" />
          </View>
        </View>
    </View>
  )
